...
def array_sort_old(data: np.ndarray, axis_: int, num_: int):
    ...
    raise DeprecationWarning(
        "This function is deprecated. Please use array_sort instead."
    )
    if axis_ == 0:
        axis = 1
...
def superellipsoid_points(
    a1, a2, a3, e1, e2, u_count=64, v_count=64, R=None, t=(0, 0, 0)
):
